...
export PROJ_ROOT=../../../AHB_memory_002
...
export INC_DIR="+incdir+$RTL_DIR +incdir+$AGENT_DIR +incdir+$AGENT_DIR/ahb_agent +incdir+$AGENT_DIR/reset_agent  +incdir+$TEST_DIR +incdir+$SEQ_DIR  +incdir+$TB_DIR +incdir+$LOG_DIR +incdir+$SIM_DIR"
